<template>
    <div class="flex items-center justify-center w-full p-20 px-10 ">
        <div class="block w-full h-full bg-gray-200 rounded-2xl">
            <div class="w-full px-5 py-1 mb-1 overflow-x-auto bg-green-400 rounded-t-2xl">
                <input v-bind="text" class="text-center rounded-md" type="text" placeholder="Text"/>
                <button class="px-2 ml-2 bg-blue-200 rounded-md">Add Folder</button>
...
export default {
    setup() {
        ...
        const addFolder=(folderName)=>{
            store.dispatch('folder/createNewFolder',folderName)
        }
